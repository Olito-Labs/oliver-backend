...
async def generate_slide_mini(request: SlideGenerationRequest) -> SlideGenerationResponse:
    ...
    try:
        ...
        system_prompt = (
            ...
            2. Ensure the slide is professional and minimalist, with a focus on clarity and impact.
            3. Use the appropriate visual elements (metrics, panels, etc.) based on the content.
            4. Ensure the slide is visually appealing and balanced.
